...
def test_executing_process():
    ...
    scheduler = Scheduler(partial_process)
    waiting_process = [i for i in range(5)]
    process1 = Process(partial_process, scheduler.get_semaphores(), waiting_process, 'E', 1)
    print(process1)
    process2 = Process(partial_process, scheduler.get_semaphores(), waiting_process, 'E', 2)
    print(process2)
